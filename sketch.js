...
function level2(){
  ...
  laser6=createSprite(200,100,50,50);
  laser7=createSprite(600,100,50,50);
  laser8=createSprite(1000,100,50,50);
  laser9=createSprite(1400,100,50,50);
  laser10=createSprite(200,200,50,50);
  laser11=createSprite(200,400,50,50);
  laser12=createSprite(200,600,50,50);

atomBomb1=createSprite(100,0,50,50);
atomBomb2=createSprite(600,0,50,50);
  ...
  atomBomb2.addImage(atomBomb);
    ...
    laser12.velocityX=12;
     ...
     if(robber.isTouching(laser6)||robber.isTouching(laser7)||robber.isTouching(laser8)||robber.isTouching(laser9)||robber.isTouching(laser10)||robber.isTouching(laser11)||robber.isTouching(laser12)){
       gameState=3;
